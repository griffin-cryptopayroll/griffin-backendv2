...
// CRYPTOCURRENCYDelete is the builder for deleting a CRYPTO_CURRENCY entity.
...
func (cd *CRYPTOCURRENCYDelete) Where(ps ...predicate.CRYPTO_CURRENCY) *CRYPTOCURRENCYDelete {
...
// CRYPTOCURRENCYDeleteOne is the builder for deleting a single CRYPTO_CURRENCY entity.
...
func (cdo *CRYPTOCURRENCYDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{crypto_currency.Label}
	default:
		return nil
	}
}
